...
class DeepFMModel(object):
    ...
    def model_fn(self, features, labels, mode, params):
        ...
        if len(params["mult_feature_names"]) > 0:
            deep_output = tf.concat([input_layer_dense, input_layer_cate, average_emb_mult], axis=1)
        else:
            deep_output = tf.concat([input_layer_dense, input_layer_cate], axis=1)
        ...
        deep_output = tf.concat([second_order, deep_output], axis=1)
